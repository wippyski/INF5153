...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Porte OR</b></em>'.
 * <!-- end-user-doc -->
 * <p>
...
public class Porte_ORImpl extends PorteImpl implements Porte_OR {
	...
	protected EClass eStaticClass() {
		return EditeurcircuitPackage.Literals.PORTE_OR;
	}
	...
	public void setEntree1(int newEntree1) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EditeurcircuitPackage.PORTE_OR__ENTREE1, oldEntree1, entree1));
	}
	...
	public void setEntree2(int newEntree2) {
		...
		entree2 = newEntree2;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EditeurcircuitPackage.PORTE_OR__ENTREE2, oldEntree2, entree2));
	}
	...
	public void setSortie1(int newSortie1) {
		...
		sortie1 = newSortie1;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EditeurcircuitPackage.PORTE_OR__SORTIE1, oldSortie1, sortie1));
	}
