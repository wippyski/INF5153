...
public class EditeurcircuitAdapterFactory extends AdapterFactoryImpl {
	...
	protected EditeurcircuitSwitch<Adapter> modelSwitch =
		new EditeurcircuitSwitch<Adapter>() {
			...
			@Override
			public Adapter caseTableVeriteObserver(TableVeriteObserver object) {
				return createTableVeriteObserverAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link editeurcircuit.TableVeriteObserver <em>Table Verite Observer</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createTableVeriteObserverAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link editeurcircuit.TableVerite <em>Table Verite</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
